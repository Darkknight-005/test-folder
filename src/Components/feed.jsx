...
import { MdPeopleAlt, MdNotificationsActive, MdArrowDropDown } from 'react-icons/md'
...
function Feed() {
  return (
    <div className="">
      <header className='backdrop-lg py-1 bg-black/70 flex  items-center  justify-evenly'>
        <div className="flex  items-start ">

          <GiLinkedRings className='text-2xl text-[lightsalmon]' />
          <div className='flex items-center gap-2 px-2 py-1 bg-black/40 outline-1 active:outline rounded'>
            <BsSearch />
            <input type="Search" className='bg-transparent outline-none flex-1 text-sm' placeholder='Search' />
          </div>
        </div>
        <div>
          <div className='flex gap-2 items-center '>
            <div className='flex gap-3 items-end '>
              ...
              <div className='flex flex-col items-center text-sm sapce-y-1'>
      ...
      <main className='h-[100vh]  lg:w-[1028px] justify-evenly'>
        <h1>
          Demo text heading
        </h1>
        <p>
