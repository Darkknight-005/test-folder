  ...
  return (
    ...
    <header className='flex items-center justify-center py-2 backdrop-blur-lg backdrop-brightness-150 bg-black/60 text-slate-100 z-10'>
        ...
        <main className=' my-5 flex flex-col gap items-center justify-center text-slate-300  '>
            <form action="" method="post" className='lg:w-[30vw] flex-none md:w-[40vw] sm:w-[70vw] xs:w-[90vw]  flex flex-col justify-start text-center px-10 pt-5 pb-10 gap-y-2 backdrop-blur-md bg-black/30 cursor-default rounded  mx-10'>
