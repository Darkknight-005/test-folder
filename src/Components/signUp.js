  ...
  return (
    ...
    <span >
        ...
        <main className=' flex flex-col gap-10 items-center justify-center text-slate-300 '>
            <form action="" method="post" className='lg:w-[30vw] flex-none md:w-[40vw] sm:w-[50vw] w-[70vw]   flex flex-col justify-start text-center px-10 pt-5 pb-10 gap-y-2 backdrop-blur-md bg-white/20 cursor-default rounded  mx-10'>
