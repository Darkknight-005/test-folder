...
function Feed() {
  ...
  return (
    <>
      <header className=' py-1 bg-black/40 backdrop-blur-sm flex  items-center text-white/40 justify-center'>
        <div className='lg:basis-[1028px] lg:flex-none flex-1 flex justify-evenly' >
          ...
          <div className='basis-[514px] flex-1' id="p_flex_i">
            <div className='flex  items-center justify-end' id="flex_icon">
